...
//WHY did we put rover_msgs here?? Could we put this in the standard msgs folder?  
...
ros::Subscriber<rover_msgs::IWC_motors> sub("IWC_motorControl", &messageCb);   //added forward slash here before IWC_motorControl
